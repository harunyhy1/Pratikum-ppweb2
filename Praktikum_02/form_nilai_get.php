...
<body>
            ...
            <div class="form-group row">
                ...
                <div class="col-7">
                    <select id="matkul" name="matkul" class="custom-select" required="required">
                        ...
                        <option value="PW">Pemrograman Web 1</option>
                    </select>
                </div>
            </div>
            <div class="form-group row">
    ...
    <div class="text-center">
        ...
        echo "<h5>Hasil Proses:</h5>";
        echo "<p><strong>Proses:</strong> " . $proses . "</p>";
...
<!--
<footer class="mt-5" style="bottom: 0; left: 0; right: 0; position: fixed; background-color: grey; color: white; text-align: center; padding: 5px 0; font-size: 14px; height: 40px;">
    <nav class="navbar navbar-expand-md navbar-light p-0">
        <div class="container d-flex justify-content-center">
            <a class="navbar-brand text-white m-0 p-0" href="#" style="font-size: 14px;">Develop By @Harunyhy1 &copy;<?= date("Y") ?></a>
        </div>
    </nav>
</footer>
    -->
